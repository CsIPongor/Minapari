...
from minapari.utils.status_messages import format_float
from minapari.utils.validators import _validate_increasing, validate_n_seq
...
class IntensityVisualizationMixin:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        # circular import
        from minapari.components.overlays import ColorBarOverlay
    ...
    @property
    def colormap(self):
        """minapari.utils.Colormap: colormap for luminance images."""
