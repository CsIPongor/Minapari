...
from minapari.layers.base._base_constants import (
    BaseProjectionMode,
    Blending,
    Mode,
)
from minapari.layers.base._base_mouse_bindings import (
    highlight_box_handles,
    transform_with_box,
)
from minapari.layers.utils._slice_input import _SliceInput, _ThickNDSlice
from minapari.layers.utils.interactivity_utils import (
    drag_data_to_projected_distance,
)
from minapari.layers.utils.layer_utils import (
    Extent,
    coerce_affine,
...
from minapari.layers.utils.plane import ClippingPlane, ClippingPlaneList
from minapari.settings import get_settings
from minapari.utils._dask_utils import configure_dask
from minapari.utils._magicgui import (
    add_layer_to_viewer,
    add_layers_to_viewer,
    get_layers,
)
from minapari.utils.events import EmitterGroup, Event, EventedDict
from minapari.utils.geometry import (
...
from minapari.utils.status_messages import (
    generate_layer_status_strings,
)
from minapari.utils.transforms import Affine, CompositeAffine, TransformChain
from minapari.utils.translations import trans

if TYPE_CHECKING:
    import numpy.typing as npt

    from minapari.components.dims import Dims
    from minapari.components.overlays.base import Overlay
    from minapari.layers._source import Source


logger = logging.getLogger('minapari.layers.base.base')
    ...
    * `_basename()`: base/default name of the layer
    ...
    def __init__(
        ...
        *,
        ...
        from minapari.layers._source import current_source
        ...
        # circular import
        from minapari.components.overlays.bounding_box import BoundingBoxOverlay
        from minapari.components.overlays.interaction_box import (
            SelectionBoxOverlay,
            TransformBoxOverlay,
        )
    ...
    def affine(self) -> Affine:
        """minapari.utils.transforms.Affine: Extra affine transform to go from physical to world coordinates."""
    ...
    def save(self, path: str, plugin: str | None = None) -> list[str]:
        ...
        """
        from minapari.plugins.io import save_layers
