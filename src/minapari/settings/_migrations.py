...
from minapari.utils.triangulation_backend import TriangulationBackend

if TYPE_CHECKING:
    from minapari.settings._napari_settings import NapariSettings
...
def v040_050(model: NapariSettings):
    ...
    e.g. '.csv' becomes '*.csv'
    """
    from minapari.settings._utils import _coerce_extensions_to_globs
...
def _swap_ctrl_cmd(keybinding):
    ...
    """
    from minapari.utils.key_bindings import KeyBinding
