...
def startup_script() -> str:
    ...
    from minapari.utils._startup_script import startup_script_status_info
...
def sys_info(as_html: bool = False) -> str:
    ...
    text = f'<b>napari</b>: {minapari.__version__}'
    ...
    try:
        ...
        from minapari.utils._appdirs import user_config_dir
