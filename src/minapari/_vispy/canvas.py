...
from minapari._vispy.mouse_event import NapariMouseEvent
from minapari._vispy.utils.cursor import QtCursorVisual
from minapari._vispy.utils.gl import get_max_texture_sizes
from minapari._vispy.utils.visual import create_vispy_overlay
from minapari.components._viewer_constants import CanvasPosition
from minapari.components.overlays import CanvasOverlay
from minapari.utils._proxies import ReadOnlyWrapper
from minapari.utils.colormaps.standardize_color import transform_color
from minapari.utils.events import disconnect_events
from minapari.utils.events.event import Event
from minapari.utils.interactions import (
...
from minapari.utils.theme import get_theme
...
if TYPE_CHECKING:
    ...
    from minapari.components.overlays import Overlay
    from minapari.layers import Layer
...
class VispyCanvas:
    ...
    Attributes
    ----------
    layer_to_visual : dict(napari.layers, minapari._vispy.layers)
    ...
    camera : minapari._vispy.VispyCamera
    ...
    _last_theme_color : Optional[npt.NDArray[np.float]]
        ...
        was applied.
    _overlay_to_visual : dict(napari.components.overlays, list(minapari._vispy.overlays))
    ...
    _layer_overlay_to_visual : dict(napari.layers.Layer, dict(napari.components.overlays, minapari._vispy.overlays))
        A mapping from each layer in the layerlist to their mappings of napari overlay->vispy counterpart.
    _scene_canvas : minapari._vispy.canvas.NapariSceneCanvas
