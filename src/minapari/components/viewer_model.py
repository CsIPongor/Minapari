...
from minapari.components.cursor import Cursor, CursorStyle
from minapari.components.dims import Dims
from minapari.components.grid import GridCanvas
...
from minapari.components.tooltip import Tooltip
from minapari.errors import (
    MultipleReaderError,
...
from minapari.utils._register import create_func as create_add_method
from minapari.utils.action_manager import action_manager
from minapari.utils.colormaps import ensure_colormap
from minapari.utils.events import (
    Event,
    EventedDict,
    EventedModel,
    disconnect_events,
...
from minapari.utils.misc import ensure_list_of_layer_data_tuple, is_sequence
from minapari.utils.mouse_bindings import MousemapProvider
from minapari.utils.progress import progress
from minapari.utils.theme import available_themes, is_theme_available
...
class ViewerModel(KeymapProvider, MousemapProvider, EventedModel):
    ...
    window : minapari._qt.qt_main_window.Window
        Parent window.
    ...
    def __init__(
        ...
        from minapari._app_model.context import create_context
    ...
    def __str__(self):
        ...
        return f'minapari.Viewer: {self.title}'
    ...
    def experimental(self):
        ...
        """
        from minapari.components.experimental.commands import (
    ...
    def open_sample(
        ...
        **kwargs
        ...
        """
        from minapari.plugins import _npe2, plugin_manager
    ...
    def _add_layers_with_plugins(
        ...
        *,
        ...
        List[Layer]
            A list of any layers that were added to the viewer.
        """
        from minapari.plugins.io import read_data_with_plugins
