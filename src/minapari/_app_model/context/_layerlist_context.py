...
from minapari._app_model.context._context_keys import ContextNamespace
...
if TYPE_CHECKING:
    ...
    from minapari.utils.events import Selection
...
def _all_linked(s: LayerSel) -> bool:
    from minapari.layers.utils._link_layers import layer_is_linked
