...
from minapari._app_model.constants import MenuGroup, MenuId
from minapari._app_model.context import LayerListSelectionContextKeys as LLSCK
from minapari.layers import _layer_actions
...
LAYERLIST_CONTEXT_ACTIONS: list[Action] = [
    ...
    Action(
        id='minapari.layer.convert_to_labels',
    ...
    Action(
        id='minapari.layer.convert_to_image',
    ...
    Action(
        id='minapari.layer.toggle_visibility',
    ...
    Action(
        id='minapari.layer.link_selected_layers',
    ...
    Action(
        id='minapari.layer.unlink_selected_layers',
    ...
    Action(
        id='minapari.layer.select_linked_layers',
    ...
    Action(
        id='minapari.layer.show_selected',
    ...
    Action(
        id='minapari.layer.hide_selected',
    ...
    Action(
        id='minapari.layer.show_unselected',
    ...
    Action(
        id='minapari.layer.hide_unselected',
    ...
    Action(
        id='minapari.layer.bounding_box',
...
for _dtype in (
    ...
    LAYERLIST_CONTEXT_ACTIONS.append(
        Action(
            id=f'minapari.layer.convert_to_{_dtype}',
...
for mode in ('max', 'min', 'std', 'sum', 'mean', 'median'):
    LAYERLIST_CONTEXT_ACTIONS.append(
        Action(
            id=f'minapari.layer.project_{mode}',
