...
from minapari._app_model.actions._toggle_action import ViewerModelToggleAction
...
toggle_action_details = [
    (
        'minapari.window.view.toggle_viewer_axes',
        trans._('Axes Visible'),
        'axes',
        'visible',
    ),
    (
        'minapari.window.view.toggle_viewer_axes_colored',
        trans._('Axes Colored'),
        'axes',
        'colored',
    ),
    (
        'minapari.window.view.toggle_viewer_axes_labels',
        trans._('Axes Labels'),
        'axes',
        'labels',
    ),
    (
        'minapari.window.view.toggle_viewer_axes_dashed',
        trans._('Axes Dashed'),
        'axes',
        'dashed',
    ),
    (
        'minapari.window.view.toggle_viewer_axes_arrows',
        trans._('Axes Arrows'),
        'axes',
        'arrows',
    ),
    (
        'minapari.window.view.toggle_viewer_scale_bar',
        trans._('Scale Bar Visible'),
        'scale_bar',
        'visible',
    ),
    (
        'minapari.window.view.toggle_viewer_scale_bar_box',
        trans._('Scale Bar Box'),
        'scale_bar',
        'box',
    ),
    (
        'minapari.window.view.toggle_viewer_scale_bar_colored',
        trans._('Scale Bar Colored'),
        'scale_bar',
        'colored',
    ),
    (
        'minapari.window.view.toggle_viewer_scale_bar_ticks',
...
VIEW_ACTIONS = [
    Action(
        id='minapari.viewer.fit_to_view',
    ...
    Action(
        id='minapari.viewer.camera.zoom_in',
    ...
    Action(
        id='minapari.viewer.camera.zoom_out',
    ...
    Action(
        id='minapari.window.view.toggle_ndisplay',
    ...
    Action(
        id='minapari.window.view.toggle_layer_tooltips',
