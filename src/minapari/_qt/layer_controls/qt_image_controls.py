...
from minapari._qt.layer_controls.qt_image_controls_base import (
    QtBaseImageControls,
)
from minapari._qt.layer_controls.widgets import QtProjectionModeControl
from minapari._qt.layer_controls.widgets._image import (
    QtDepictionControl,
...
class QtImageControls(QtBaseImageControls):
    ...
    Attributes
    ----------
    _depiction_control : minapari._qt.layer_controls.widgets._image.QtDepictionControl
        Widget that wraps widgets related with the layer depiction and plane attributes.
    _interpolation_control : minapari._qt.layer_controls.widgets._image.QtInterpolationComboBoxControl
        Widget that wraps dropdown menu to select the interpolation mode for image display.
    _projection_mode_control : minapari._qt.layer_controls.widgets.QtProjectionModeControl
        Widget that wraps dropdown menu to select the projection mode for the layer.
    _render_control : minapari._qt.layer_controls.widgets._image.QtImageRenderControl
        Widget that wraps widgets related with the method used to render the layer.
    """

    layer: 'minapari.layers.Image'
