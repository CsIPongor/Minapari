...
from minapari._qt.layer_controls.widgets import (
    QtOpacityBlendingControls,
    QtWidgetControlsBase,
)
from minapari._qt.utils import set_widgets_enabled_with_opacity
from minapari._qt.widgets.qt_mode_buttons import QtModeRadioButton
...
class QtLayerControls(QFrame):
    ...
    _opacity_blending_controls: minapari._qt.layer_controls.widgets.QtOpacityBlendingControls
    ...
    layer : napari.layers.Layer
        An instance of a napari layer.
    panzoom_button : minapari._qt.widgets.qt_mode_button.QtModeRadioButton
        Button to activate move camera mode for layer.
    transform_button : minapari._qt.widgets.qt_mode_button.QtModeRadioButton
    ...
    def _add_widget_controls(
        ...
        Parameters
        ----------
        wrapper : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWidgetControlsBase
    ...
    def _radio_button(
        ...
        **kwargs,
        ...
        extra_tooltip_text : str
            ...
            action manager
        **kwargs:
            Passed to minapari._qt.widgets.qt_mode_button.QtModeRadioButton

        Returns
        -------
        button: minapari._qt.widgets.qt_mode_button.QtModeRadioButton
