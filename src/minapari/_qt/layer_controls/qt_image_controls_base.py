...
from minapari._qt.layer_controls.qt_layer_controls_base import QtLayerControls
...
class QtBaseImageControls(QtLayerControls):
    ...
    Attributes
    ----------
    _colormap_control : minapari._qt.layer_controls.widgets.QtColormapControl
        Widget that wraps combobox and label widgets related with the layer colormap attribute.
    _contrast_limits_control : minapari._qt.layer_controls.widgets.QtContrastLimitsControl
        Widget that wraps layer contrast range slider and autocontrast widgets.
    _gamma_slider_control : minapari._qt.layer_controls.widgets.QtGammaSliderControl
