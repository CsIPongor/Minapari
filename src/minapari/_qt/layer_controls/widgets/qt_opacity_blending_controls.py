...
from minapari._qt.utils import attr_to_settr
from minapari.layers.base._base_constants import BLENDING_TRANSLATIONS, Blending
from minapari.layers.base.base import Layer
from minapari.utils.events.event_utils import connect_setattr
...
class QtOpacityBlendingControls(QtWidgetControlsBase):
    ...
    blend_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
        Label for the blending combobox widget.
    opacity_slider : superqt.QLabeledDoubleSlider
        Slider controlling opacity of the layer.
    opacity_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
