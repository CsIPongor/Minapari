...
from minapari._qt.utils import checked_to_bool, qt_signals_blocked
...
class QtTextVisibilityControl(QtWidgetControlsBase):
    ...
    text_disp_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
