...
from minapari.utils.colormaps import (
    AVAILABLE_COLORMAPS,
...
class QtColormapControl(QtWidgetControlsBase):
    ...
    colormap_widget_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
    ...
    def _on_make_colormap(self):
        ...
        from minapari._qt.utils import get_color
        from minapari.utils.colormaps.colormap_utils import ensure_colormap
