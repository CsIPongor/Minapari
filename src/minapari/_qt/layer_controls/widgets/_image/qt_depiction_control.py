...
from minapari.layers.image._image_constants import VolumeDepiction
...
class QtDepictionControl(QtWidgetControlsBase):
    ...
    depiction_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
    ...
    plane_normal_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
    ...
    plane_thickness_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
