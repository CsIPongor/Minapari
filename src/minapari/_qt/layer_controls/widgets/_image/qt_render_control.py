...
from minapari._qt.utils import attr_to_settr, qt_signals_blocked
...
class QtImageRenderControl(QtWidgetControlsBase):
    ...
    render_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
