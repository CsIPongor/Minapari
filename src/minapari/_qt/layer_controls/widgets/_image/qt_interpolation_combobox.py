...
from minapari.layers.image._image_constants import Interpolation
...
class QtInterpolationComboBoxControl(QtWidgetControlsBase):
    ...
    interpolation_combobox_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
