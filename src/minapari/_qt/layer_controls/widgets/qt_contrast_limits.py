...
from minapari._qt.layer_controls.widgets.qt_widget_controls_base import (
    QtWidgetControlsBase,
    QtWrappedLabel,
)
from minapari._qt.utils import qt_signals_blocked
from minapari._qt.widgets.qt_range_slider_popup import QRangeSliderPopup
from minapari.layers import Image, Surface
from minapari.utils._dtype import normalize_dtype
from minapari.utils.events.event_utils import connect_no_arg, connect_setattr
...
class QtContrastLimitsControl(QtWidgetControlsBase):
    ...
    auto_scale_bar_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
        Label for the auto-contrast functionality widget.
    clim_popup : minapari._qt.qt_range_slider_popup.QRangeSliderPopup
    ...
    contrast_limits_slider_label : minapari._qt.layer_controls.widgets.qt_widget_controls_base.QtWrappedLabel
