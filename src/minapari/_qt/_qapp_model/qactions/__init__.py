...
from minapari._qt._qapp_model.injection._qprocessors import QPROCESSORS
from minapari._qt._qapp_model.injection._qproviders import QPROVIDERS
...
def init_qactions() -> None:
    ...
    """
    from minapari._app_model import get_app_model
    from minapari._qt._qapp_model.qactions._debug import (
        DEBUG_SUBMENUS,
        Q_DEBUG_ACTIONS,
    )
    from minapari._qt._qapp_model.qactions._file import (
        Q_FILE_ACTIONS,
    )
    from minapari._qt._qapp_model.qactions._help import Q_HELP_ACTIONS
    from minapari._qt._qapp_model.qactions._layerlist_context import (
        Q_LAYERLIST_CONTEXT_ACTIONS,
    )
    from minapari._qt._qapp_model.qactions._layers_actions import (
        LAYERS_ACTIONS,
        LAYERS_SUBMENUS,
    )
    from minapari._qt._qapp_model.qactions._plugins import Q_PLUGINS_ACTIONS
    from minapari._qt._qapp_model.qactions._view import (
        Q_VIEW_ACTIONS,
    )
    from minapari._qt._qapp_model.qactions._window import Q_WINDOW_ACTIONS
...
def add_dummy_actions(context: Context) -> None:
    ...
    """
    from minapari._app_model import get_app_model
    from minapari._app_model.constants._menus import MenuId
    from minapari._app_model.utils import get_dummy_action, is_empty_menu
