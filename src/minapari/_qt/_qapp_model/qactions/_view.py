...
Q_VIEW_ACTIONS: list[Action] = [
    Action(
        id='minapari.window.view.toggle_fullscreen',
    ...
    Action(
        id='minapari.window.view.toggle_command_palette',
    ...
    Action(
        id='minapari.window.view.toggle_menubar',
    ...
    Action(
        id='minapari.window.view.toggle_play',
    ...
    Action(
        id='minapari.window.view.toggle_activity_dock',
