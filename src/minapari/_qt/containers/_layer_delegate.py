...
from minapari._app_model.context import get_context
from minapari._qt._qapp_model import build_qmodel_menu
from minapari._qt.containers._base_item_model import ItemRole
from minapari._qt.containers.qt_layer_model import LoadedRole, ThumbnailRole
from minapari._qt.qt_resources import QColoredSVGIcon
from minapari.resources import LOADING_GIF_PATH
...
class LayerDelegate(QStyledItemDelegate):
    ...
    :class:`minapari._qt.containers.QtLayerList`.  The `QStyledItemDelegate`
