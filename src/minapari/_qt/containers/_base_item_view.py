...
from minapari._qt.containers._factory import create_model
...
if TYPE_CHECKING:
    ...
    from minapari._qt.containers._base_item_model import _BaseEventedItemModel
...
class _BaseEventedItemView(Generic[ItemType]):
    ...
    :class:`minapari._qt.containers.QtListView` subclass.
    For a nested list-of-lists using the Group/Node classes, use the
    :class:`minapari._qt.containers.QtNodeTreeView` subclass.

    For convenience, the :func:`minapari._qt.containers.create_view` factory
