...
from minapari._qt.containers.qt_axis_model import AxisList, QtAxisListModel
from minapari.components.layerlist import LayerList
from minapari.utils.events import SelectableEventedList
from minapari.utils.translations import trans
from minapari.utils.tree import Group
...
def create_view(
    ...
    """
    from minapari._qt.containers import QtLayerList, QtListView, QtNodeTreeView
...
def create_model(
    ...
    """
    from minapari._qt.containers import (
        QtLayerListModel,
        QtListModel,
        QtNodeTreeModel,
    )
