...
from minapari.utils.events.containers import SelectableEventedList
...
class _BaseEventedItemModel(QAbstractItemModel, Generic[ItemType]):
    ...
    :class:`minapari._qt.containers.QtListModel` subclass.
    For a nested list-of-lists using the Group/Node classes, use the
    :class:`minapari._qt.containers.QtNodeTreeModel` subclass.

    For convenience, the :func:`minapari._qt.containers.create_model` factory
    ...
    .. note::
        ...
        :class:`minapari._qt.containers.QtListView` or
        :class:`minapari._qt.containers.QtNodeTreeView` views, or the
        :func:`minapari._qt.containers.create_view` factory function.
