...
from minapari.utils.tree import Group, Node
...
class QtNodeTreeModel(_BaseEventedItemModel[NodeType]):
    ...
    :class:`~minapari._qt.containers.QtNodeTreeView`.

    See docstring of :class:`_BaseEventedItemModel` and
    :class:`~minapari._qt.containers.QtNodeTreeView` for additional background.
    """
