...
from minapari._qt.dialogs.qt_modal import QtPopup
from minapari._qt.utils import qt_signals_blocked
from minapari._qt.widgets.qt_mirrored_sliders_popup import QMirroredSlidersPopup
from minapari._qt.widgets.qt_scrollbar import ModifiedScrollBar
from minapari.components import Dims
from minapari.settings import get_settings
from minapari.settings._constants import LoopMode
from minapari.utils.events.event_utils import connect_setattr_value
...
class QtDimSliderWidget(QWidget):
    ...
    def loop_mode(self):
        ...
        Loop mode enumeration minapari._qt._constants.LoopMode
    ...
    def loop_mode(self, value):
        ...
        Parameters
        ----------
        value : minapari._qt._constants.LoopMode
            Loop mode for animation.
            Available options for the loop mode string enumeration are:
            - LoopMode.ONCE
                Animation will stop once movie reaches the max frame
    ...
    def _update_play_settings(self, fps, loop_mode, frame_range):
        ...
        loop_mode : minapari._qt._constants.LoopMode
            Loop mode for animation.
            Available options for the loop mode string enumeration are:
            - LoopMode.ONCE
                Animation will stop once movie reaches the max frame
