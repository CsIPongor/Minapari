...
from minapari.utils.notifications import Notification, NotificationSeverity
...
class NapariQtNotification(QDialog):
    ...
    def from_notification(
        ...
        from minapari.utils.notifications import ErrorNotification
...
def _debug_tb(tb):
    ...
    from minapari._qt.utils import event_hook_removed
