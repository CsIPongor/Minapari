...
from minapari.utils.task_status import Status
...
class _NotifyingMixin:
    ...
    def _relay_error(self, exc: Exception):
        from minapari.utils.notifications import notification_manager
...
def register_threadworker_processors():
    ...
    from minapari.types import LayerDataTuple
    from minapari.utils import _magicgui as _mgui
