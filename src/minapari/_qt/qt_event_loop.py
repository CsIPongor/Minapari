...
from minapari._qt.qt_event_filters import QtToolTipEventFilter
from minapari._qt.qthreading import (
    register_threadworker_processors,
    wait_for_workers_to_quit,
)
from minapari._qt.utils import _maybe_allow_interrupt
from minapari.resources._icons import _theme_path
from minapari.settings import get_settings
from minapari.utils import config, perf
from minapari.utils._logging import register_logger_to_napari_handler
from minapari.utils.notifications import (
    notification_manager,
    show_console_notification,
)
from minapari.utils.perf import perf_config
from minapari.utils.theme import _themes
...
NAPARI_APP_ID = f'minapari.napari.viewer.{__version__}'
...
def get_qapp(
    *,
    ...
    if app:
        ...
        if perf_config and perf_config.trace_qt_events:
            from minapari._qt.perf.qt_event_tracing import (
