...
from minapari._qt.containers import QtLayerList
from minapari._qt.dialogs.qt_reader_dialog import handle_gui_reading
from minapari._qt.dialogs.screenshot_dialog import ScreenshotDialog
from minapari._qt.perf.qt_performance import QtPerformance
from minapari._qt.utils import QImg2array
from minapari._qt.widgets.qt_dims import QtDims
from minapari._qt.widgets.qt_viewer_buttons import (
    QtLayerButtons,
    QtViewerButtons,
)
from minapari._qt.widgets.qt_viewer_dock_widget import QtViewerDockWidget
from minapari._qt.widgets.qt_welcome import QtWidgetOverlay
from minapari.components.camera import Camera
from minapari.components.layerlist import LayerList
from minapari.errors import MultipleReaderError, ReaderPluginError
from minapari.layers.base.base import Layer
from minapari.plugins import _npe2
from minapari.settings import get_settings
from minapari.settings._application import DaskSettings
from minapari.utils import config, perf, resize_dask_cache
from minapari.utils.action_manager import action_manager
from minapari.utils.geometry import get_center_bbox
from minapari.utils.history import (
    get_open_history,
    get_save_history,
    update_open_history,
    update_save_history,
...
from minapari.utils.key_bindings import KeymapHandler
from minapari.utils.misc import in_ipython, in_jupyter
from minapari.utils.naming import CallerFrame
from minapari.utils.notifications import show_info
from minapari.utils.translations import trans
from napari_builtins.io import imsave_extensions

from minapari._vispy import VispyCanvas, create_vispy_layer  # isort:skip

if TYPE_CHECKING:
    from napari_console import QtConsole
    from npe2.manifest.contributions import WriterContribution

    from minapari._qt.layer_controls import QtLayerControlsContainer
    from minapari.components import ViewerModel
...
class QtViewer(QSplitter):
    ...
    _qt_poll : Optional[minapari._qt.experimental.qt_poll.QtPoll]
    ...
    _welcome_widget : minapari._qt.widgets.qt_welcome.QtWidgetOverlay
...
if TYPE_CHECKING:
    from minapari._qt.experimental.qt_poll import QtPoll
    from minapari.components.experimental.remote import RemoteManager
...
def _create_remote_manager(layers: LayerList, qt_poll) -> RemoteManager | None:
    ...
    from minapari.components.experimental.monitor import monitor
    from minapari.components.experimental.remote import RemoteManager
