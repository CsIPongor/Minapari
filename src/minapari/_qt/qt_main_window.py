...
from minapari._app_model.constants import MenuId
from minapari._app_model.context import create_context, get_context
from minapari._qt._qapp_model import build_qmodel_menu
from minapari._qt._qapp_model.qactions import add_dummy_actions, init_qactions
from minapari._qt._qapp_model.qactions._debug import _is_set_trace_active
from minapari._qt._qplugins import (
    _rebuild_npe1_plugins_menu,
    _rebuild_npe1_samples_menu,
)
from minapari._qt.dialogs.confirm_close_dialog import ConfirmCloseDialog
from minapari._qt.dialogs.preferences_dialog import PreferencesDialog
from minapari._qt.dialogs.qt_activity_dialog import QtActivityDialog
from minapari._qt.dialogs.qt_notification import NapariQtNotification
from minapari._qt.dialogs.shimmed_plugin_dialog import ShimmedPluginDialog
from minapari._qt.qt_event_loop import (
    NAPARI_ICON_PATH,
    get_qapp,
    quit_app as quit_app_,
)
from minapari._qt.qt_resources import get_stylesheet
from minapari._qt.qt_viewer import QtViewer
from minapari._qt.threads.status_checker import StatusChecker
from minapari._qt.utils import QImg2array, qbytearray_to_str, str_to_qbytearray
from minapari._qt.widgets.qt_command_palette import QCommandPalette
from minapari._qt.widgets.qt_viewer_dock_widget import (
    _SHORTCUT_DEPRECATION_STRING,
    QtViewerDockWidget,
)
from minapari._qt.widgets.qt_viewer_status_bar import ViewerStatusBar
from minapari.plugins import (
    menu_item_template as plugin_menu_item_template,
    plugin_manager,
)
from minapari.plugins._npe2 import index_npe1_adapters
from minapari.settings import get_settings
from minapari.utils import perf
from minapari.utils._proxies import MappingProxy, PublicOnlyProxy
from minapari.utils.events import Event
from minapari.utils.io import imsave
from minapari.utils.misc import (
    in_ipython,
    in_jupyter,
    in_python_repl,
    running_as_constructor_app,
)
from minapari.utils.notifications import Notification
from minapari.utils.task_status import Status, TaskStatusManager
from minapari.utils.theme import _themes, get_system_theme
...
class _QtMainWindow(QMainWindow):
    ...
    # `minapari._qt.qt_main_window._QtMainWindow._window_icon`
...
class Window:
    ...
    def _handle_trace_file_on_start(self):
        ...
        from minapari._qt._qapp_model.qactions._debug import _start_trace
    ...
    def add_plugin_dock_widget(
        ...
        tuple
            ...
            instance).
        """
        from minapari.plugins import _npe2
    ...
    def _screenshot(
        ...
        img : QImage
        """
        from minapari._qt.utils import add_flash_animation
    ...
    def _screenshot_dialog(self):
        ...
        from minapari._qt.dialogs.screenshot_dialog import ScreenshotDialog
        from minapari.utils.history import get_save_history, update_save_history
...
def _instantiate_dock_widget(wdg_cls, viewer: 'Viewer'):
    ...
    from minapari.viewer import Viewer, ViewerModel
    ...
    # Inspection can fail when adding to bundle as it thinks widget is a builtin
        ...
        for param in sig.parameters.values():
            ...
            if param.annotation in (
                'minapari.viewer.Viewer',
                Viewer,
                'minapari.viewer.ViewerModel',
                'minapari.components.ViewerModel',
                'minapari.components.viewer_model.ViewerModel',
                ViewerModel,
            ):
